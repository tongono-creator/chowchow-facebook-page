...
def generate_meme_hook(subject, vibe):
    ...
    prompt = (
        f"สัตว์: {subject}\n"
        f"vibe ที่เห็น: {vibe}\n"
        "เขียน hook text ภาษาไทยสั้นๆ กวนๆ ตลกๆ ลงบนรูปภาพเสมือนเป็นความคิดในหัวของสัตว์ในภาพ (Pet POV / Inner Monologue):\n"
...
def generate_meme_caption(subject, vibe, subreddit):
    ...
    prompt = (
        ...
        "ใช้โทนตลกหน้าตาย ประชดแบบรักๆ แต่อิหยังวะ ภาษาพูดคนเลี้ยงหมาแมวทั่วไป\n"
