...
def generate_dog_dilemma(title="", body="", subreddit="dogs"):
    prompt = (
        ...
        '  "seed_comment": "ความคิดเห็นของแอดมินทาสหมาตัวตึง (ลงท้ายฮะ/ครับ) ที่เลือกข้างชัดเจนข้างใดข้างหนึ่งทันทีเพื่อเปิดประเด็นถกเถียง และลงท้ายด้วย \'2/2\'"\n'
        "}"
    )
    ...
    if not line1 or not caption or not seed_comment or not contains_thai(line1) or not contains_thai(caption):
        ...
        fallbacks = [
            ...
            },
            {
                ...
                "seed_comment": "ดุไปน้องก็ลืมภายในสิบวินาทีฮะ เคสนี้ต้องโทษตัวเองที่ไม่เก็บของเล่นขัดฟันไว้ให้เพียงพอ กอดโอ๋แล้วก้มหน้าสั่งโซฟาใหม่ฮะ 2/2"
            },
            {
                "line1": "อาบน้ำ 3 ชั่วโมง",
                "line2": "วิ่งคลุกโคลน 3 วิ",
                "caption": "เรื่องจริงยิ่งกว่าละครของคนเลี้ยงหมาขนหนาครับ เจ้าของพาหมาไปอาบน้ำเป่าขนแปลงโฉมมาครึ่งวัน หมดเงินไปหลักพัน พอพาลงเดินหน้าบ้านปุ๊บน้องกระโดดลงหลุมโคลนคลุกทั้งตัวแบบมีความสุขสุดขีด ถ้าเป็นชาวทาสจะร้องไห้แล้วจับอาบใหม่ หรือปล่อยจอยให้เล่นโคลนให้หนำใจก่อนฮะ? 1/2",
                "seed_comment": "เมื่อโคลนเปื้อนแล้ว แปลว่าความพยายาม 3 ชั่วโมงสูญเปล่าฮะ ปล่อยให้น้องเล่นให้สุดก่อน แล้วค่อยลากกลับไปอาบใหม่อีกรอบ 2/2"
            }
        ]
