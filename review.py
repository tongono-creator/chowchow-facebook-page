...
def generate_caption(detail, shopee, lazada, promo, highlights):
    ...
    prompt = (
        f"เขียน Facebook post ภาษาไทยรีวิวสินค้าอย่างตรงไปตรงมาและน่าอ่าน สไตล์เพจรีวิวสินค้าโดยสวมบทบาทเป็นน้องหมา Chow Chow เพศผู้ (ชื่อแอดมินน้องตูบ) เล่าเรื่องราวหรือนำเสนอสินค้าอย่างแสนซน ขี้อ้อน และตรงไปตรงมา มีคำลงท้ายภาษาตูบตัวผู้เสมอ เช่น 'ฮะ', 'ครับ' หรือมีเสียงร้อง 'โฮ่ง' บ้าง ใช้สรรพนามแทนตัวว่า 'ผม' หรือ 'น้องตูบ' \n"
        f"รายละเอียดสินค้า:\n{detail}\n\n"
        f"จุดเด่นสินค้า:\n{highlights}\n\n"
        f"คุณต้องเขียนรีวิวโดยใช้เทคนิค 3 ขั้นตอนดังนี้:\n"
        f"1. เปิดให้น่าสนใจ (Hook): ประโยคเปิดหัวพาดหัวเรื่องให้น่าตื่นเต้น ขี้เล่น หรือน่ารักสไตล์น้องตูบ\n"
        f"2. เล่าให้เห็นภาพ (Vivid Storytelling): รีวิวการใช้งานจริง ประโยชน์ หรือคุณสมบัติให้เห็นภาพชัดเจนแสนซนแบบน้องหมา\n"
        f"3. ปิดจบต้องบอกว่า 'ควรทำอะไร' (Call to Action): บอกให้กดเข้าไปสั่งที่ตะกร้า ชี้เป้าลิงก์ หรือบอกว่ากำลังมีโปรโมชั่นพิเศษราคาดีอยู่ (ลงท้าย ฮะ/ครับ/โฮ่ง)\n\n"
        f"เขียนให้น่าอ่าน สั้นกระชับ เป็นกันเอง สดใสสไตล์สุนัขเพศผู้สุดกวน ท้ายโพสต์ใส่แฮชแท็ก 2-3 อัน\n"
        f"ห้ามขึ้นต้นด้วยวลีสูตร เช่น 'สวัสดีครับ', 'โฮ่ง! วันนี้น้องตูบ...', 'ในยุคที่...', 'ปัจจุบัน...' ให้เปิดด้วยความตึงเครียด ความน่ารัก หรือประโยชน์รูปธรรมตรงๆ ใส่ความเห็นส่วนตัวอย่างน้อย 1 ประโยค (เช่น 'ส่วนตัวรู้สึกว่า...' หรือ 'จุดที่ถูกใจคือ...') ห้ามทุกประโยคมีโครงสร้างหรือจังหวะสมมาตร\n"
