...
def is_product_suitable_for_page(detail):
    ...
    if "iphone" in text or "apple" in text:
        return True
    """Allow dog products only; generic pet files often contain cat products too."""
    text = str(detail or "").lower()
    ...
    dog_terms = (
        ...
        "โกลเด้น", "ลาบราดอร์", "สัตว์เลี้ยง", "pet", "เครื่องเป่าขน",
    )
...
ROLES = [
    {"id": "R1", "name": "ทาสหมาหาข้อมูล", "desc": "คนเลี้ยงหมาที่กำลังเทียบข้อมูลก่อนซื้อ ไม่อ้างว่าเคยใช้สินค้า"},
    {"id": "R2", "name": "ดูแลความปลอดภัย", "desc": "มองว่าสินค้าเกี่ยวข้องกับความปลอดภัยหรือความสบายของสุนัขอย่างไรจากข้อมูลที่มี"},
    {"id": "R3", "name": "ศาลทาสหมา", "desc": "หยิบรายละเอียดไปตั้งคำถามเฉพาะให้คนเลี้ยงหมาช่วยแชร์ประสบการณ์จริง"},
    {"id": "R4", "name": "ชี้พิกัดของหมา", "desc": "บอกประเภท จุดเด่น และราคาแบบกลางๆ ไม่เร่งซื้อและไม่แต่งประสบการณ์"}
]
...
PERSONAS = [
    {"id": "A", "name": "น้องตูบคัดของ", "desc": "แอดมินน้องหมาที่ไปเจอสินค้าสุนัขมาและเล่าจากข้อมูลจริง ไม่อ้างว่าเคยใช้"},
    {"id": "B", "name": "ทาสหมาหาข้อมูล", "desc": "มุมคนกำลังเปรียบเทียบข้อมูลสินค้าและชวนผู้ใช้จริงมาช่วยตอบ"},
    {"id": "C", "name": "เพื่อนชี้พิกัด", "desc": "ชี้พิกัดแบบไม่เร่งขาย บอกเฉพาะประเภท จุดเด่น และราคาที่ตรวจได้"},
    {"id": "D", "name": "ศาลทาสหมา", "desc": "ตั้งคำถามเฉพาะเรื่องการเลี้ยงหมาที่สัมพันธ์กับสินค้านี้"}
]

HOOKS = [
    "เปิดด้วยปัญหาของคนเลี้ยงหมาที่สินค้าประเภทนี้เกี่ยวข้อง",
    "เปิดด้วยจุดเด่นจริงหนึ่งข้อจากข้อมูล",
    "เปิดด้วยราคาเทียบกับฟังก์ชันที่ได้",
    "เปิดด้วยคำถามเฉพาะถึงบ้านที่เคยใช้จริง",
    "เปิดด้วยข้อที่ทาสหมาควรตรวจสอบก่อนซื้อ"
]

STYLES = [
    {"name": "มุกน้องหมาเบาๆ", "desc": "มีมุกสั้นใน Persona น้องหมา แต่ห้ามแต่งว่าเคยใช้สินค้า"},
    {"name": "ปัญหาและทางเลือก", "desc": "ชี้ปัญหาของทาสหมาหนึ่งข้อ แล้ววางสินค้าเป็นตัวเลือก ไม่รับรองผล"},
    {"name": "คำถามเฉพาะ", "desc": "ถามเรื่องสเปก ราคา หรือการใช้งานกับสุนัขโดยตรง"},
    {"name": "บอกต่อแบบกลางๆ", "desc": "เล่าประเภท จุดเด่น และราคา ไม่เร่งซื้อ"}
]
