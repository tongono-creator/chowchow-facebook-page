...
def generate_caption(detail, shopee, lazada, promo, highlights):
    ...
    _archetypes_p = [
        "น้องหมา Chow Chow ที่เพิ่งลองของมาแล้ว อยากบอกต่อเพื่อนๆ ไม่ได้ขายของ",
        "น้องหมา Chow Chow ที่มีปัญหาในชีวิตประจำวัน แล้วบังเอิญเจอสินค้าตัวนี้ช่วยแก้",
        "น้องหมา Chow Chow ที่เจอราคาดี กลัวเพื่อนพลาดเลยรีบบอก",
        "น้องหมา Chow Chow ที่ใช้มาสักพักแล้ว มาเล่าประสบการณ์จริงให้ฟัง",
    ]
    _archetype_p = _archetypes_p[_seed_p % 4]
    prompt = (
        f"คุณคือ{_archetype_p} ใช้คำลงท้าย 'ฮะ' หรือ 'โฮ่ง' และสรรพนาม 'น้องตูบ' หรือ 'ผม'\n"
        f"ก่อนเขียน ให้คิดก่อนว่า: สินค้านี้แก้ปัญหาอะไร คนซื้อเพราะอะไร จุดไหนที่ทำให้รู้สึกว่า 'น่าสนใจ'\n\n"
        f"รายละเอียดสินค้า:\n{detail}\n\n"
        f"เขียน Facebook post ตามลำดับนี้:\n"
        f"1. เปิดด้วยปัญหาหรือความรู้สึกแบบหมา — ห้ามขึ้นต้นด้วยชื่อสินค้าหรือแบรนด์\n"
        ...
        f"5. จบด้วย 'กดลิ้งในคอมเมนต์แรกได้เลยฮะ 👇'\n\n"
        f"ความยาว: 3-5 ประโยค\n"
        f"ห้ามใช้: คุ้มมาก, ของมันต้องมี, รีบซื้อ, โปรโมชั่น, สั่งได้เลย, อย่าพลาด\n"
        f"ห้าม copy ชื่อสินค้าเต็มจาก Shopee, ห้าม bullet points, ห้าม **\n"
    ...
    _fallback_templates = [
        f"โฮ่ง! เจอของดีมาบอกต่อ น้องตูบลองแล้วชอบฮะ{_price_str}\n\nกดลิ้งในคอมเมนต์แรกได้เลย 👇",
        f"มีปัญหาแบบนี้อยู่เหมือนกัน เพิ่งหาทางออกเจอฮะ{_price_str}\n\nรายละเอียดในคอมเมนต์แรก 👇",
        f"นานๆ จะเจอของดีราคานี้ แปะไว้ก่อนนะฮะ{_price_str}\n\nดูในคอมเมนต์แรก 👇",
        f"ใช้มาพักนึงแล้ว ดีกว่าที่คิดไว้ฮะ{_price_str}\n\nกดลิ้งในคอมเมนต์แรก 👇",
    ]
