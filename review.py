...
def generate_caption(detail, shopee, lazada, promo, highlights):
    ...
    prompt = (
        ...
        f"✅ ดี: [สรุปจุดดีเด่นๆ ของสินค้า 2-3 บรรทัดสั้นๆ รีวิวในมุมของสุนัขเพศผู้แสนซน ลงท้าย ฮะ/ครับ]\n"
        f"⚠️ ข้อเสีย: [สรุปข้อควรระวังหรือข้อเสียอย่างจริงใจ 1-2 บรรทัด ลงท้าย ฮะ/ครับ]\n"
        f"💡 คุ้มไหม: [สรุปสั้นๆ ว่าคุ้มค่าเหมาะกับใคร ลงท้าย ฮะ/ครับ]\n\n"
